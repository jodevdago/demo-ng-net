			...
			if (!context.Tickets.Any())
			{
				...
				context.Tickets.AddRange(
					...
					new Ticket
					{
						...
						Desc = "La latence des requètes dépasse les 3s pendant les heures de pointe.",
						Priority = 1,
						Status = TicketStatus.PENDING,
						AssignedId = jonathan.Id
					},
					...
					new Ticket
					{
						Id = Guid.NewGuid(),
						Title = "API lente",
						Desc = "Les réponses de léAPI mettent plus de 5s.",
						Priority = 2,
						Status = TicketStatus.PENDING,
						AssignedId = tommy.Id
					},
					...
					{
						Id = Guid.NewGuid(),
						Title = "Bug déaffichage sur mobile",
						Desc = "Le tableau de bord ne séaffiche pas correctement sur iOS.",
						Priority = 2,
						Status = TicketStatus.INPROGRESS,
						AssignedId = tommy.Id
					},
					new Ticket
					{
						...
						Desc = "Le formulaire permet déenvoyer des données vides sans alerte.",
						Priority = 2,
					...
					new Ticket
					{
						...
						Desc = "La page 'Rapports mensuels' met plus de 10s é se charger.",
						Priority = 2,
						Status = TicketStatus.PENDING,
						AssignedId = tommy.Id
					},
					new Ticket
					{
						...
						Desc = "Les utilisateurs ne reçoivent pas l'email aprés l'inscription.",
						Priority = 2,
						Status = TicketStatus.FINISHED,
						AssignedId = tommy.Id
					},
					new Ticket
					{
						...
						Desc = "Méme avec des termes valides, la recherche reste vide.",
						Priority = 2,
						Status = TicketStatus.INPROGRESS,
						AssignedId = tommy.Id
					},
					...
					{
						Id = Guid.NewGuid(),
						Title = "Page blanche aprés login",
						Desc = "Une page blanche s'affiche juste aprés la connexion.",
						Priority = 2,
						Status = TicketStatus.PENDING,
						AssignedId = evan.Id
					},
					...
					new Ticket
					{
						...
						Desc = "Un mot est mal orthographié sur la page déaccueil.",
						Priority = 2,
						Status = TicketStatus.PENDING,
						AssignedId = john.Id
					},
					...
					{
						Id = Guid.NewGuid(),
						Title = "Lien vers les CGU obsoléte",
					...
					new Ticket
					{
						...
						Desc = "L'icone du site n'apparaét pas dans l'onglet du navigateur.",
						Priority = 2,
						Status = TicketStatus.CLOSED,
						AssignedId = john.Id
					},
